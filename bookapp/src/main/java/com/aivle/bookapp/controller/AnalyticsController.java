...
import com.aivle.bookapp.dto.AiReadingReportRequest;
...
public class AnalyticsController {
    ...
    @PostMapping("/users/{userId}/reading-report/ai")
    public ReadingReportResponse getAiReadingReport(
            @PathVariable Long userId,
            @RequestBody AiReadingReportRequest request
    ) {
        return analyticsService.getAiReadingReport(
                userId,
